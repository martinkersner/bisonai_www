...
The main building blocks of convolutional neural networks are convolutional layers and the great majority of [inference]({{ "/glossary#inference" | prepend: site.url }}) time is <a href="#figure7">spent in them</a> <a href="#lmgemm_ref">[2]</a>.
