...
<center>
<img src="{{ "/img/blog/nmnf/act_conv_act_conv.png" | prepend: site.url }}" width="30%">
</center>
...
<center>
<img src="{{ "/img/blog/nmnf/qtanh_levels.png" | prepend: site.url }}" width="80%">
</center>
...
<center>
<img src="{{ "/img/blog/nmnf/lookup_table.png" | prepend: site.url }}" width="35%">
</center>
...
<center>
<img src="{{ "/img/blog/nmnf/quant_conv_diagram.png" | prepend: site.url }}" width="40%">
</center>
...
<center>
<img src="{{ "/img/blog/nmnf/activation_array_with_delta_x.png" | prepend: site.url }}" width="50%">
</center>
...
<center>
<img src="{{ "/img/blog/nmnf/weight_distribution.png" | prepend: site.url }}" width="80%">
</center>
...
<center>
<img src="{{ "/img/blog/nmnf/alexnet.png" | prepend: site.url }}" width="70%">
</center>
...
<center>
<img src="{{ "/img/blog/nmnf/alexnet_breakdown.png" | prepend: site.url }}" width="60%">
</center>
*Figure 7: Layer-wise inference time breakdown of float AlexNet model run on Samsung Galaxy Note 3.*
...
<center>
<img src="{{ "/img/blog/nmnf/nmnf_vs_ncnn.png" | prepend: site.url }}" width="60%">
</center>
